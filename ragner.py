...
def spawn_collectible():
    ...
    if len(collectibles) < max_collectibles:
        ...
        rotation = 0  # Add rotation for animation
        
        # Store as [x, y, z, type, rotation]
        collectibles.append([x, y, z, cube_type, rotation])

def draw_collectible(x, y, z, cube_type, rotation):
...
def update_collectibles():
    ...
    for collectible in collectibles:
        collectible[4] = (collectible[4] + 2) % 360  # Rotate 2 degrees per frame
